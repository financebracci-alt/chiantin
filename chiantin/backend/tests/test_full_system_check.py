"""
COMPREHENSIVE FULL SYSTEM TEST for Chiantin Banking Platform
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://user-alert-system-2.preview.emergentagent.com')
